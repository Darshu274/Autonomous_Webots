"""
RosBot Final System - "Slow Initial 360 Scan"

UPDATES:
1. SLOW INITIAL SPIN: The robot starts with a slow 360-degree rotation (speed 2.0) 
   to reliably detect pillars behind it without motion blur.
2. PRESERVED: Speed Run, Red Wall Logic, Fixed Poison Geometry, Lost Mode.
"""
...
INITIAL_SCAN_SPEED = 2.0      # <--- NEW: Slow speed for initial 360 scan
...
STATE_INITIAL_SPIN = 12       # <--- Initial Spin State
...
# --- Main Loop ---
print("System Initialized: Slow 360 Spin -> Explore -> Speed Run.")
